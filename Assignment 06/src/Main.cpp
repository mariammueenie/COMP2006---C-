...
// // To ensure that main.cpp has access to all arcade globals, structs, and functions
// namespace arcade {
...
// // =========================================================
//     arcade::PlayerName arcade::getPlayerName();
...
//         string validFirstName = arcade::player.first;
//         string validLastName  = arcade::player.last;
//         // assign to the global player
