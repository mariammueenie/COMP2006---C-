...
// To build and play game in VS Developer Command Prompt
/*

cd "C:\Users\maria\Documents\GitHub\COMP2006---C-\Assignment 02\Games (Individual)"
del build\actualassignment02.exe 2>nul
cl /std:c++17 /EHsc actualassignment02.cpp /Fe:build\actualassignment02.exe
build\actualassignment02.exe
...
/*
PROGRAM OUTLINE
ARCADE LOOP: INTRODUCTION, TITLE, GET NAME FROM USER, GAME CHOICE SCREEN LOOP
(Fayzabanu)
        ...
        switch (gameChoice) {
            ...
            case 3: {
                ...
                do {
                    ...
                    cout << "Please enter your LOTTO numbers (You should input seven numbers) from 1-49, "
                         << firstName << ".\n\n";
                    ...
                    while (true) {
                        ...
                        if (NumberGuess3 < 1 || NumberGuess3 > 49) { cout << "Out of range. Try again.\n\n";
                            continue; }
                        if (NumberGuess3 == NumberGuess1 || NumberGuess3 == NumberGuess2) {
                            cout << "Repeat number. Try again.\n\n"; continue; }
                        break;
                    }
                    ...
                    while (true) {
                        ...
                        if (NumberGuess4 < 1 || NumberGuess4 > 49) { cout << "Out of range. Try again.\n\n";
                            continue; }
                        if (NumberGuess4 == NumberGuess1 || NumberGuess4 == NumberGuess2 || NumberGuess4 == NumberGuess3) {
                            cout << "Repeat number. Try again.\n\n"; continue; }
                        break;
                    }
                    ...
                    while (true) {
                        ...
                        if (NumberGuess5 < 1 || NumberGuess5 > 49) { cout << "Out of range. Try again.\n\n";
                            continue; }
                        if (NumberGuess5 == NumberGuess1 || NumberGuess5 == NumberGuess2 ||
                            NumberGuess5 == NumberGuess3 || NumberGuess5 == NumberGuess4) {
                            cout << "Repeat number. Try again.\n\n"; continue; }
                        break;
                    }
                    ...
                    while (true) {
                        ...
                        if (NumberGuess6 < 1 || NumberGuess6 > 49) { cout << "Out of range. Try again.\n\n";
                            continue; }
                        if (NumberGuess6 == NumberGuess1 || NumberGuess6 == NumberGuess2 ||
                            NumberGuess6 == NumberGuess3 || NumberGuess6 == NumberGuess4 || NumberGuess6 == NumberGuess5) {
                            cout << "Repeat number. Try again.\n"; continue; }
                        break;
                    }
                    ...
                    while (true) {
                        ...
                        if (NumberGuess7 == NumberGuess1 || NumberGuess7 == NumberGuess2 || NumberGuess7 == NumberGuess3 ||
                            NumberGuess7 == NumberGuess4 || NumberGuess7 == NumberGuess5 || NumberGuess7 == NumberGuess6) {
                            cout << "Repeat number. Try again.\n\n"; continue; }
                        break;
                    }
                    ...
                    // generate 7 unique random numbers between 1 and 49 (your original repeated style)
                    ...
                    do { GeneratedNumber2 = (rand() % 49) + 1; }
                    while (GeneratedNumber2 == GeneratedNumber1);

                    do { GeneratedNumber3 = (rand() % 49) + 1; }
                    while (GeneratedNumber3 == GeneratedNumber1 || GeneratedNumber3 == GeneratedNumber2);

                    do { GeneratedNumber4 = (rand() % 49) + 1; }
                    while (GeneratedNumber4 == GeneratedNumber1 || GeneratedNumber4 == GeneratedNumber2 || GeneratedNumber4 == GeneratedNumber3);

                    do { GeneratedNumber5 = (rand() % 49) + 1; }
                    while (GeneratedNumber5 == GeneratedNumber1 || GeneratedNumber5 == GeneratedNumber2 ||
                           GeneratedNumber5 == GeneratedNumber3 || GeneratedNumber5 == GeneratedNumber4);

                    do { GeneratedNumber6 = (rand() % 49) + 1; }
                    while (GeneratedNumber6 == GeneratedNumber1 || GeneratedNumber6 == GeneratedNumber2 ||
                           GeneratedNumber6 == GeneratedNumber3 || GeneratedNumber6 == GeneratedNumber4 || GeneratedNumber6 == GeneratedNumber5);

                    do { GeneratedNumber7 = (rand() % 49) + 1; }
                    while (GeneratedNumber7 == GeneratedNumber1 || GeneratedNumber7 == GeneratedNumber2 ||
                           GeneratedNumber7 == GeneratedNumber3 || GeneratedNumber7 == GeneratedNumber4 ||
                           GeneratedNumber7 == GeneratedNumber5 || GeneratedNumber7 == GeneratedNumber6);
                    ...
                    // compare user input numbers to generated numbers (pair-wise)
                    bool allEqual = true;
                    for (int i = 1; i <= 7; i++) {
                        int guess = 0, draw = 0;
                        switch (i) {
                            case 1: guess = NumberGuess1; draw = GeneratedNumber1; break;
                            case 2: guess = NumberGuess2; draw = GeneratedNumber2; break;
                            case 3: guess = NumberGuess3; draw = GeneratedNumber3; break;
                            case 4: guess = NumberGuess4; draw = GeneratedNumber4; break;
                            case 5: guess = NumberGuess5; draw = GeneratedNumber5; break;
                            case 6: guess = NumberGuess6; draw = GeneratedNumber6; break;
                            case 7: guess = NumberGuess7; draw = GeneratedNumber7; break;
                        }
                        if (guess != draw) {
